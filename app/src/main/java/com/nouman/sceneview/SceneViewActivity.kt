...
class SceneViewActivity : AppCompatActivity() {
    ...
    var localModel = "Miraitowa_1.sfb"
    ...
    private fun addNodeToScene(model: ModelRenderable) {
        if (sceneView != null) {
            ...
            var dragTransformableNode = DragTransformableNode(0.15f, transformationSystem)
            ...
            val animationData = model.getAnimationData("Miraitowa_1")

            val andyAnimator = ModelAnimator(animationData, model)
            andyAnimator.start()
            Log.d("vls", "test")
        }
    }
